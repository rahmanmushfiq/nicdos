...
<a href="contact_page.html"><button class="button" ><span>Contact</span></button></a>
	...
	<div class="container">
		<form action="home_page.html" method="post" name="myfm" align="left">
			First Name : <br/>
			<input type="text" name="firstName"  onkeyup="check_fn(this)"> <a id="fn_msg"> </a> <br/>
			Last Name : <br/>
			<input type="text" name="lastName" value="" onkeyup="check_ln(this)"> <a id="ln_msg"> </a><br/>
			Date of Birth : <br/>
			<select name="day">
				<?php
for ($i = 0; $i <= 31; $i++) {
...
?>
			...
			Phone :  <br/>
			<input type="text" name="phone" placeholder="Phone.." onkeyup="check_phone(this)"> <a id="phn_msg"> </a><br/>

			Email : <br/>
			<input type="text" name="email" placeholder="Email.." onkeyup="check_email(this)"> <a id="eml_msg"> </a><br/>
			Username:<br/>
			<input type="text" name="uname" id="unm" value="" onkeyup="check_uname(this)"> <a id="uname_msg"> </a><br/>

			Password : <br/>
			<input type="password" name="password" value="" onkeyup="check_pass(this)"> <a id="ps_msg"> </a><br/>

			Confirm password : <br/>
			<input type="password" name="confirmPassword" value="" onkeyup="check_conpass(this)"> <a id="cnps_msg"> </a><br/></br/>
